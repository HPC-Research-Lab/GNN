...
In this work, we target the large memory consumption issue of SCO algorithms and propose a new algorithm that maintains sparse moving averages of aggregated features for GNN training. 
